...
for cc in $CONGESTION_CONTROL; do
  for loss_rate in $LOSS_RATES; do
    ...
    ./bbr_experiment.py --cc=$cc --loss=$loss_rate --traceup traces/ATT-LTE-driving-2016.up --tracedown traces/ATT-LTE-driving-2016.down --output_file=$LOG_FILE $@ --experiment experiment4 
  done
done
